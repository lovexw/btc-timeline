...
const bitcoinData = {
    ...
    timeline: [
        ...
        },
        {
            date: "2009年1月3日",
            title: "创世区块诞生",
            description: "中本聪挖掘了第一个比特币区块（创世区块），标志着比特币网络的正式启动。创世区块中刻入了一句经典的话：'The Times 03/Jan/2009 Chancellor on brink of second bailout for banks'，这是当天英国《泰晤士报》的头版标题，反映了当时的金融危机背景。",
        ...
        },
        {
            date: "2010年12月",
            title: "中本聪消失",
            description: "中本聪停止参与比特币项目，逐渐淡出社区。他将项目控制权交给了Gavin Andresen，之后再也没有出现过，成为了历史上最神秘的人物之一。这标志着比特币从单一创始人到社区共治的转变。",
            tags: ["中本聪", "项目交接", "历史关键点"]
        },
        {
            date: "2010年5月22日",
